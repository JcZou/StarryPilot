...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' --specs=nano.specs'
    AFLAGS = ' -c' + DEVICE + ' -x assembler-with-cpp'
    LFLAGS = DEVICE + ' -nostartfiles --specs=nano.specs -Wl,-no-wchar-size-warning,--gc-sections,-Map=starryio.map,-cref,-u,Reset_Handler -T stm32_rom.ld'
    ...
    POST_ACTION = OBJCPY + ' -O binary $TARGET starryio.bin\n' + SIZE + ' $TARGET \n'
