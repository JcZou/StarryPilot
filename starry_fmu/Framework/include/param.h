...
typedef struct
{
	...
	PARAM_DECLARE(ACC_TRANS_MAT_0_0);
	PARAM_DECLARE(ACC_TRANS_MAT_0_1);
	PARAM_DECLARE(ACC_TRANS_MAT_0_2);
	PARAM_DECLARE(ACC_TRANS_MAT_1_0);
	PARAM_DECLARE(ACC_TRANS_MAT_1_1);
	PARAM_DECLARE(ACC_TRANS_MAT_1_2);
	PARAM_DECLARE(ACC_TRANS_MAT_2_0);
	PARAM_DECLARE(ACC_TRANS_MAT_2_1);
	PARAM_DECLARE(ACC_TRANS_MAT_2_2);
	PARAM_DECLARE(MAG_X_OFFSET);
	PARAM_DECLARE(MAG_Y_OFFSET);
	PARAM_DECLARE(MAG_Z_OFFSET);
	PARAM_DECLARE(MAG_TRANS_MAT_0_0);
	PARAM_DECLARE(MAG_TRANS_MAT_0_1);
	PARAM_DECLARE(MAG_TRANS_MAT_0_2);
	PARAM_DECLARE(MAG_TRANS_MAT_1_0);
	PARAM_DECLARE(MAG_TRANS_MAT_1_1);
	PARAM_DECLARE(MAG_TRANS_MAT_1_2);
	PARAM_DECLARE(MAG_TRANS_MAT_2_0);
	PARAM_DECLARE(MAG_TRANS_MAT_2_1);
	PARAM_DECLARE(MAG_TRANS_MAT_2_2);
...
typedef struct
{
	...
	PARAM_DECLARE(ATT_ROLL_OUTPUT_LIMIT);
	PARAM_DECLARE(ATT_PITCH_OUTPUT_LIMIT);
	PARAM_DECLARE(ATT_YAW_OUTPUT_LIMIT);
	PARAM_DECLARE(ATT_ROLL_RATE_I_LIMIT);
	PARAM_DECLARE(ATT_PITCH_RATE_I_LIMIT);
	PARAM_DECLARE(ATT_YAW_RATE_I_LIMIT);
...
typedef struct
{
	...
	PARAM_DECLARE(FEEDFORWARD_ENABLE);
	PARAM_DECLARE(ACC_ERR_LPF_ENABLE);
	PARAM_DECLARE(ACC_ERR_LPF_CUTOFF_FREQ);
...
typedef struct
{
	PARAM_DECLARE(HIL_ATT_EST_PERIOD);
	PARAM_DECLARE(HIL_POS_EST_PERIOD);
	PARAM_DECLARE(HIL_CONTROL_PERIOD);
}PARAM_GROUP(HIL_SIM);
