...
{ \
	...
	PARAM_DEFINE_FLOAT(GYR_X_GAIN, PI/180.0f),
	PARAM_DEFINE_FLOAT(GYR_Y_GAIN, PI/180.0f),
	PARAM_DEFINE_FLOAT(GYR_Z_GAIN, PI/180.0f),
	PARAM_DEFINE_FLOAT(ACC_X_OFFSET, 0.0),
	PARAM_DEFINE_FLOAT(ACC_Y_OFFSET, 0.0),
	PARAM_DEFINE_FLOAT(ACC_Z_OFFSET, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_0_0, 1.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_0_1, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_0_2, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_1_0, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_1_1, 1.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_1_2, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_2_0, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_2_1, 0.0),
	PARAM_DEFINE_FLOAT(ACC_TRANS_MAT_2_2, 1.0),
	PARAM_DEFINE_FLOAT(MAG_X_OFFSET, 0.0),
	PARAM_DEFINE_FLOAT(MAG_Y_OFFSET, 0.0),
	PARAM_DEFINE_FLOAT(MAG_Z_OFFSET, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_0_0, 1.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_0_1, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_0_2, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_1_0, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_1_1, 1.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_1_2, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_2_0, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_2_1, 0.0),
	PARAM_DEFINE_FLOAT(MAG_TRANS_MAT_2_2, 1.0),
};
...
{ \
	...
	PARAM_DEFINE_FLOAT(ATT_ROLL_OUTPUT_LIMIT, 0.5), 
	PARAM_DEFINE_FLOAT(ATT_PITCH_OUTPUT_LIMIT, 0.5), 
	PARAM_DEFINE_FLOAT(ATT_YAW_OUTPUT_LIMIT, 0.2), 
	PARAM_DEFINE_FLOAT(ATT_ROLL_RATE_I_LIMIT, 0.1), 
	PARAM_DEFINE_FLOAT(ATT_PITCH_RATE_I_LIMIT, 0.1), 
	PARAM_DEFINE_FLOAT(ATT_YAW_RATE_I_LIMIT, 0.1), 
};
...
{ \
	...
	PARAM_DEFINE_INT32(FEEDFORWARD_ENABLE, 1),
	PARAM_DEFINE_INT32(ACC_ERR_LPF_ENABLE, 1),
	PARAM_DEFINE_FLOAT(ACC_ERR_LPF_CUTOFF_FREQ, 5),
};
...
{ \
	...
	PARAM_DEFINE_FLOAT(LESO_W, 150.0f),
...
{ \
	PARAM_DEFINE_UINT32(HIL_ATT_EST_PERIOD, 4),
	PARAM_DEFINE_UINT32(HIL_POS_EST_PERIOD, 10),
	PARAM_DEFINE_UINT32(HIL_CONTROL_PERIOD, 4),
};
