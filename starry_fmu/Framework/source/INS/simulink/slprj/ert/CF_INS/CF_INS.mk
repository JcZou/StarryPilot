...
## Build Info:
## 
## Final product: ./CF_INS_rtwlib.lib
...
COMPILER_COMMAND_FILE     = CF_INS_comp.rsp
CMD_FILE                  = CF_INS.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
INCLUDES_BUILDINFO = -I./referenced_model_includes -I$(START_DIR) -I$(START_DIR)/slprj/ert/CF_INS -I$(START_DIR)/Model -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=CF_INS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/CF_INS/CF_INS.c $(START_DIR)/slprj/ert/CF_INS/CF_INS_data.c
...
OBJS = CF_INS.obj CF_INS_data.obj
...
%.obj : $(START_DIR)/slprj/ert/CF_INS/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
