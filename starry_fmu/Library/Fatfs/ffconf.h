...
#define	_USE_STRFUNC	1 //1支持字符串操作，0不支持
...
//#define	_USE_MKFS		0 //定时是否格式化，这里不格式化
#define	_USE_MKFS		1 //定时是否格式化，这里不格式化
/* This option switches f_mkfs() function. (0:Disable or 1:Enable)
/  To enable it, also _FS_READONLY need to be set to 0. */


//#define	_USE_FASTSEEK	0 //是否使能快速定位
#define	_USE_FASTSEEK	1 //是否使能快速定位
/* This option switches fast seek feature. (0:Disable or 1:Enable) */


//#define _USE_LABEL		0 //是否支持磁盘盘符读取与设置
#define _USE_LABEL		1 //是否支持磁盘盘符读取与设置
...
#define _CODE_PAGE	936 //语言类型，我们设置成c936.c文件格式
...
//#define	_USE_LFN	0
#define	_USE_LFN	0	//TODO:短文件名不支持大小写
#define	_MAX_LFN	255
